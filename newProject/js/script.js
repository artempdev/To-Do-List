document.addEventListener('DOMContentLoaded', () => {
    ...
    modalWindow.addEventListener('click', (e) => {
        if (e.target && (e.target === modalWindow || e.target.getAttribute('data-close') == '')) {
            closeModal();
        }
    });
    ...
    //Cards classes
    class MenuCard {
        constructor(link, alt, title, desc, price, parentSelector, ...classes) {
            this.link = link;
            this.alt = alt;
            this.title = title;
            this.desc = desc;
        ...
        render() {
            ...
            element.innerHTML = `                 
            <img src=${this.link} alt=${this.alt}>
